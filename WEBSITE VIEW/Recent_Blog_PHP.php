          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              <ul class="navbar-nav  mb-3 mb-lg-0" style="font-size: 20px;">
                ...
                <li class="nav-item mx-2">
                  <a class="nav-link" href="Contect-Us_Page.html">Contact-Us</a>
                </li>
                <li class="nav-item1 dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="#">Recent Blogs</a></li>
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          <div class="col">
            <div class="card shadow-sm mx-0 my-1">
              <img src="BLOGOSPHERE_RECENT.png" alt="img" width="100%" height="225">
